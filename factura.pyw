...
def limpiar(evt, confirmar=False):
    ...
    panel['cliente']['domicilio'].value = ""
    panel['cliente']['email'].value = ""
    panel['cliente']['cat_iva'].data_selection = None
    panel['tipo_cbte'].data_selection = None
...
def recalcular():
    neto_iva = {}
    imp_iva = {}
    tasas_iva = {1: 0., 2: 0., 3: 0., 4: 10.5, 5: 21, 6: 27}
    total = 0.
...
gui.StatusBar(name='statusbar_15_91', 
                  text=u'Servicio Web Factura Electr\xf3nica mercado interno (WSFEv1)', parent='mywin')

gui.Panel(name='panel', parent='mywin')

# panel "cliente"
gui.Panel(label=u'Cliente:', name='cliente', 
            height='114', left='8', top='6', width='633', image='', parent='mywin.panel')
gui.Label(name='label_182_163', height='25', left='11', 
            top='21', width='38', text=u'Documento:', parent='mywin.panel')

gui.ComboBox(name='tipo_doc', text=u'CF', 
             left='111', top='16', width='78', 
             onchange=on_tipo_doc_change,
             items=datos.TIPO_DOC_MAP,
             selection=1, string_selection=u'DNI', parent='cliente')
gui.TextBox(mask='##-########-#', name='nro_doc', 
            left='192', top='17', width='110', 
            value=u'20-26756539-3', onblur=on_nro_doc_change, parent='mywin.panel.cliente'
            )
gui.Label(name='label_268_164', height='31', left='316', 
          top='22', width='61', text=u'Nombre:', parent='cliente')
gui.TextBox(name='nombre', 
            left='383', top='17', width='240', 
            value=u'Mariano Reingart', parent='cliente')
gui.Label(name='label_322_165', left='10', top='50', 
          width='72', text=u'Domicilio', parent='cliente')
gui.TextBox(name='domicilio', multiline=True, 
            height='57', left='112', top='49', width='189', 
            value=u'Castagna 4942', parent='cliente')
gui.Label(name='label_530_167', left='321', top='85', 
          width='58', text=u'E-Mail:', parent='cliente')
gui.Label(name='label_530_167_1258', height='17', left='321', 
          top='56', width='58', text=u'IVA:', parent='cliente')
...
gui.Label(name='label_356_21_155', height='17', left='467', 
          top='130', width='60', text=u'Fecha:', parent='mywin.panel')
gui.TextBox(id=290, mask='date', name='fecha_cbte', left='517', top='125', 
            width='122', 
            value=datetime.date(2014, 5, 27), parent='mywin.panel')
# panel "conceptos"
gui.Panel(label=u'Conceptos a incluir', name='conceptos', 
...
gui.ComboBox(name='forma_pago', value=u'Contado', 
             ...
             items=[u"Contado", u"Tarjeta de Débito",
                    ...
                    u"Cheque", u"Ticket", u"Otra"], parent='conceptos')
# panel "periodo"
gui.Panel(label=u'Per\xedodo Facturado', name='periodo', 
                   height='89', left='276', top='158', width='363', 
                   image='', parent='mywin.panel')
gui.Label(name='label_272_30_1442_1458', height='17', 
          left='17', top='25', width='49', text=u'Desde:', parent='periodo')
gui.Label(name='label_272_30', left='192', top='25', width='49', 
          text=u'Hasta:', parent='periodo')
gui.TextBox(id=998, mask='date', name='fecha_desde', 
            left='72', top='20', width='113', 
            value=datetime.date(2014, 5, 28), parent='periodo')
gui.TextBox(mask='date', name='fecha_hasta', left='240', top='20', 
            width='113', 
            value=datetime.date(2014, 5, 28), parent='periodo')
gui.Label(name='label_272_30_1442', height='17', left='113', 
          top='57', width='49', text=u'Vto. para el Pago:', parent='periodo')
gui.TextBox(mask='date', name='fecha_venc_pago', 
            left='241', top='51', width='113', 
            value=datetime.date(2014, 5, 28), parent='periodo')

# nootebook
gui.Notebook(name='notebook', height='197', left='7', 
                          top='249', width='631', selection=0, parent='mywin.panel')
# tab articulos
gui.TabPanel(name='tab_art', selected=True, 
              text=u'Art\xedculos', parent='notebook')
gui.GridView(name=u'items', height='118', left='10', 
                  top='6', width='610', row_label="",
                  ongridcellchanged=on_grid_cell_change, parent='tab_art')
gui.GridColumn(align='right', name='qty', type='double', 
...
gui.GridColumn(align='right', name=u'precio', type='double', 
               ...
               width=75, parent='items')
gui.GridColumn(align='center', name=u'iva_id', represent='%s', 
               choices={1: "No gravado", 2: "Exento", 
                        3: "0%", 4: "10.5%", 5: "21%" , 
                        6: "27%"},
               text=u'IVA', type='choice', width=50, parent='items')
gui.GridColumn(align='right', name=u'subtotal', type='double', 
               represent=u'%0.2f', text=u'Subtotal', 
               width=75, format="15,2", parent='items')
gui.Button(label=u'Agregar', name='agregar', left='6', 
           top='127', width='85px', onclick=on_agregar_click, parent='tab_art')
gui.Button(id=493, label=u'Borrar', name='borrar', 
           left='94', top='127', width='85px', onclick= on_borrar_click ,parent='tab_art')
gui.Button(label=u'Modificar', name='modificar', left='183', 
           top='128', width='85px', visible=False ,parent='tab_art')

#tab alicuotas iva
gui.TabPanel(name='alicuotas_iva', selected=False, 
                              text=u'Al\xedcuotas IVA', parent='notebook')
gui.ListView(name='listado', height='100', 
...
gui.ListColumn(name=u'base_imp', text=u'Base Imp.', 
               width=100, represent="%.2f", align="right", parent='listado')
gui.ListColumn(name=u'importe', text=u'Importe IVA', 
               width=100, represent="%.2f", align="right", parent='listado')
gui.Label(name='label_388', left='20', top='11', 
          text=u'Subtotales de IVA liquidado por al\xedcuota:', parent='alicuotas_iva')
gui.Label(name='label_387_630', height='17', left='393', 
          top='71', width='92', text=u'No Gravado:', parent='alicuotas_iva')
gui.TextBox(name='imp_tot_conc', left='519', top='67', width='92', 
            mask='#######.##', alignment='right', editable=False, parent='alicuotas_iva')
gui.Label(name='label_387_542', height='17', left='393', 
          top='40', width='99', text=u'Neto Gravado:', parent='alicuotas_iva')
gui.TextBox(name='imp_neto', mask='#######.##', alignment='right', 
            left='519', top='36', width='92', editable=False, parent='alicuotas_iva')
gui.Label(name='label_387', left='395', top='100', 
          text=u'Exento:', parent='alicuotas_iva')
gui.TextBox(name='imp_op_ex',  mask='#######.##', alignment='right', 
            left='519', top='97', width='92', editable=False, parent='alicuotas_iva')

# tab tributos
gui.TabPanel(id=869, name='tributos', selected=False, 
                              text=u'Otros tributos', parent='notebook')
gui.GridView(name='grilla', height='102', 
                  left='12', top='18', width='606', item_count=0, 
                  sort_column=0, parent='tributos')
gui.GridColumn(name='tributo_id', text=u'id', width=25, 
               type='number', parent='grilla')
gui.GridColumn(name='impuesto', text=u'Impuesto', width=75,
               choices={1: "nacional", 2: "provincial", 
                        3: "municipal", 4: "interno", 
                        99: "otro"},
               type='choice', parent='grilla')
gui.GridColumn(name='desc', text=u'Descripci\xf3n', 
               width=200, type='text', parent='grilla')
gui.GridColumn(name='base_imp', text=u'Base Imp.', 
               width=75, type='double', format='11,2',parent='grilla')
gui.GridColumn(name='alic', text=u'Al\xedcuota', width=75,
               type='double', format='3,2',parent='grilla')
gui.GridColumn(name='importe', text=u'Importe', width=125,
               type='double', format='15,2',parent='grilla')
gui.Button(label=u'Agregar', name='agregar', left='6', 
           top='127', width='85px', parent='tributos')
gui.Button(id=493, label=u'Borrar', name='borrar', 
           left='94', top='127', width='85px', parent='tributos')
gui.Button(label=u'Modificar', name='modificar', left='183', 
           top='128', width='85px', visible=False, parent='tributos')
# tab obs
gui.TabPanel(name='obs', selected=False, 
                              text=u'Observaciones', parent='notebook')
gui.Label(name='label_1324', left='15', top='65', 
          text=u'Obs. Comerciales:', parent='obs')
gui.Label(id=1938, name='label_1324_1938', height='17', left='14', 
          top='15', width='106', text=u'Obs. Generales:', parent='obs')
gui.Label(name='label_1325', left='15', top='110', 
          text=u'Obs. AFIP:', parent='obs')
